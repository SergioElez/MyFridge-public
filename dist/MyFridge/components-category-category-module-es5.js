(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-category-category-module"], {
    ...
    /***/
    function aSRr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      CategoryModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        ...
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_4__["MatCardModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_5__["MatButtonModule"], _category_routing_module__WEBPACK_IMPORTED_MODULE_2__["CategoryRoutingModule"]]]
      });
    ...
    /***/
    function hLhg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function mJAr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function CategoryComponent_mat_card_15_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var CategoryComponent = /*#__PURE__*/function () {
        function CategoryComponent(route, appService) {
        ...
        _createClass(CategoryComponent, [{
          ...
          value: function getRecipesByCategory(categoryName) {
            ...
            this.appService.getRecipesByCategory(categoryName).subscribe(function (data) {
              data.meals.forEach(function (meal, index) {
                _this.recipesBySpecificCategory[index] = meal;
              });

              _this.appService.setRecipesByCategory(_this.recipesBySpecificCategory);
            });
          }
        }]);
      ...
      CategoryComponent.ɵfac = function CategoryComponent_Factory(t) {
        return new (t || CategoryComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_app_service__WEBPACK_IMPORTED_MODULE_2__["AppService"]));
      };
      ...
      CategoryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 16,
        vars: 6,
        consts: [["id", "category"], [1, "container"], [1, "row"], [1, "four", "columns"], ["id", "categoryThumb", 3, "src"], [1, "eight", "columns"], [1, "twelve", "columns"], ["id", "grid"], [4, "ngFor", "ngForOf"], ["mat-card-image", "", "alt", "", 3, "src"], ["mat-raised-button", "", 3, "routerLink"]],
...
//# sourceMappingURL=components-category-category-module-es5.js.map